...
def main():
    ...
    # --- 1. Read query params if present ---
    query_params = st.query_params
    default_urls = query_params.get("urls", "")

    input_urls = st.text_area("Enter image URLs", value = default_urls, height=100)
    ...
    if image_urls:
        ...
        if st.button("Analyze"):
            st.query_params["urls"] = input_urls
            all_results = []
